...
if __name__ == '__main__':
    """Під час запуску через термінал в якості аргумента потрібно ввести назву міста українською мовою 
    (якщо не вводити, за замовчуванням буде виводитись погода в м.Київ)
    наприклад: python Task3.py Полтава
    """
    if len(sys.argv) > 1:
